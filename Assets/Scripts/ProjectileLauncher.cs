...
public class ProjectileLauncher : MonoBehaviour
{
    ...
    void SpawnProjectile(long UserId)
    {
        ...
        //发送坐标，经过坐标系转换的坐标点
        CustomMessages.Instance.SendShootProjectile(anchor.InverseTransformPoint(ProjectilePosition)
            , anchor.InverseTransformDirection(ProjectileDirection));
    }
